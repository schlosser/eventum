"""
.. module:: home
    :synopsis: All routes on the ``home`` Blueprint.
...
@home.route('/jobfair', methods=['GET'])
def jobfair():
    ...
    **Methods:** ``GET``
    ...
    return render_template('jobfair.html', companies=_companies)


@home.route('/labs', methods=['GET'])
def labs():
    ...
    **Methods:** ``GET``
    ...
    if not _faqs or force:
        with open(current_app.config['FAQ_PATH']) as f:
            _faqs = json.loads(f.read()).get('questions')
    return render_template('labs.html', faqs=_faqs)


@home.route('/learn', methods=['GET'])
def learn():
...
@home.route('/resources', methods=['GET'])
def resources():
    ...
    **Methods:** ``GET``
    ...
    return render_template('resources.html', resources=_resources)


@home.route('/events', methods=['GET'])
def events():
...
@home.route('/events/<int:index>', methods=['GET'])
...
@home.route('/events/<slug>', methods=['GET'])
def event(slug):
...
@home.route('/events/<slug>/<index>', methods=['GET'])
